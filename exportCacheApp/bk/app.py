...
from tool.ptAlembic import abcExport
reload(abcExport)
...
class MyForm(QtGui.QMainWindow):
	...
	def getCachePathInfo(self, increment) : 

		info = abcExport.getSceneInfo()
		...
		if info : 
			...
			if abcExport.exportDept == dept : 
				...
				return {'cachePath': exportPath, 'dataPath': dataPath, 'nonCachePath': nonCachePath, 'nonCacheDataPath': nonCacheDataPath, 'cacheDir': cacheDir}
